...
description: >
  ...
  category, keywords, and authors. Generates structured reading-note .md files.
...
Output goes to `<obsidian-vault>/reading-notes/` as structured reading notes.
...
3. **Summarize** — call DeepSeek API for matching papers (note structure built into the script)
4. **Save** — write individual .md files to `<obsidian-vault>/reading-notes/`
